...
public class Spielfeld {
	...
	public Spielfeld(){
		...
		pa1.add(new JButton(""),BorderLayout.NORTH);
		pa1.add(new JButton(""), BorderLayout.EAST);
		pa1.add(new JButton(""), BorderLayout.WEST);
		pa1.add(new JButton(""),BorderLayout.SOUTH);
